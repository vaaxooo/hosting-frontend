<template>
    <div class="block-filter content">
        <div class="form-group filter-type">
            ...
            <input type="search" list="rubricsList" class="form-select form-select-lg input-rubrics" placeholder="Выберите рубрику">
        ...
        <form name="shedules_list" class="form-group filter-type">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="scheduleId" id="2"
                       data-shedule="Стажировка / практика">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <input type="number" name="salaryFrom" id="salaryFrom"
                               class="form-control form-control-lg input-salary">
